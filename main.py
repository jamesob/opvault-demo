...
class VaultsState:
    ...
    A "pure function" in the sense tha it doesn't make RPC calls or manipulate
    any state outside of what is maintained in this class.
    """
...
FEE_WALLET_SEED = b"\x01" + (b"\x00" * 31)
